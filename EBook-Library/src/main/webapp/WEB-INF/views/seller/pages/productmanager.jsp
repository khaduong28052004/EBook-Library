...
const image = "${pageContext.request.contextPath}/images/${images[0]}";
...
const image = "${pageContext.request.contextPath}/images/${images[1]}";
if (!imagesArray.includes(image)) {
	imagesArray.push(image);
}
...
if ('${images[2]}'.length > 0) {
	const image = "${pageContext.request.contextPath}/images/${images[2]}";
	if (!imagesArray.includes(image)) {
		imagesArray.push(image);
	}
...
if ('${images[3]}'.length > 0) {
	const image = "${pageContext.request.contextPath}/images/${images[3]}";
	if (!imagesArray.includes(image)) {
		imagesArray.push(image);
	}
