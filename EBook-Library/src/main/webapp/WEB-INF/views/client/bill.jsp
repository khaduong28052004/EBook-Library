					...
					<div class="row">
						<div class="col-9 menuNgangNe">
							<div class="nav navbar">
								...
								<!-- 									hủy</a></li> -->
								<!-- 							<li class="nav-item"><a -->
								<%-- 								class="nav-linkMenu ${activeMenu == 'TRAHANG' ? 'activeMenu3' : ''}" --%>
								<!-- 								id="traHang" aria-current="page" href="/user/bill/TRAHANG">Trả -->
								<!-- 									hàng/Hoàn tiền</a></li> -->
							</div>
						</div>
					</div>
									...
									<c:forEach var="billDetail" items="${bill.billDetails}">
										<div class="book">
											...
											<div class="book-content">
												<a href="/Ebook/account/billDetails">${billDetail.product.name}</a>
												<!-- Tên sản phẩm -->
