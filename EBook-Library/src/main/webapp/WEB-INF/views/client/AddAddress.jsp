	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header">
				<h1 style="font-family: serif;">THÊM ĐỊA CHỈ</h1>
			</div>

			<div class="card-body">
				<form action="/Ebook/user/create" method="post">
					<div class="col-md-12">
						<div class="form-floating mb-3">
							<input name="nameaddress" type="text" class="form-control" id="floatingInput"
						...
						<div class="form-floating">
							<input name="fullnameaddress" type="text" class="form-control" id="floatingInput"
