...
<body>
	<div class="container" id="container">
		<div class="form-container sign-up">
			<form action="/Ebook/account/register" method="post">
				<h1>Đăng Ký</h1>
		...
		<div class="form-container sign-in">
			<form action="/Ebook/account/login" method="post" >
				<h1>Đăng Nhập</h1>
				<div class="social-icons">
					<a href="#" class="icon"><i class='bx bxl-facebook'></i></a> <a
						href="#" class="icon"><i class='bx bxl-google'></i></a> <a
		...
		<div class="form-container forgotPassword">	
			<form action="/Ebook/account/otp"  method="post">
				<h1>Quên Mật Khẩu</h1>
				<div class="social-icons">
					<a href="#" class="icon"><i class='bx bxl-facebook'></i></a> <a
						href="#" class="icon"><i class='bx bxl-google'></i></a> <a
				...
				<input type="email" placeholder="Email" name="gmail"> <a
