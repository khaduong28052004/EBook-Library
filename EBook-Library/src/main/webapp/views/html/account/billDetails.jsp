        ...
        <div class="container-muaBanh">
          <div class="card cardMuaBanh">
            <div class="card-body row">
              <div class="col-md-6" style="font-weight: 150;">Cảm ơn bạn đã mua sắm tại VirtualLibaryWeb!</div>
              <div class="col-md-6"><button type="button" class="btn btn-danger">Mua Lại</button></div>
            </div>
          </div>
          <div class="card cardMuaBanh">
            <div class="card-body row">
              <div class="col-md-6" style="font-weight: 150;">Cảm ơn bạn đã mua sắm tại VirtualLibaryWeb!</div>
              <div class="col-md-6"><button type="button" class="btn btn-danger">Hủy Đơn</button></div>
            </div>
          </div>
          <div class="card cardMuaBanh">
            <div class="card-body row">
              <div class="col-md-6"></div>
              <div class="col-md-6"><button type="button" class="btn btn-light">Liên Hệ Người Bán</button></div>
            </div>
          </div>
          ...
          <div class="card cardMuaBanh">
            <div class="card-body row">
              <div class="col-md-6"></div>
              <div class="col-md-6"><button type="button" class="btn btn-light">Xem Đáng Giá Shop</button></div>
            </div>
          </div>
        </div>
          ...
          <div class="card card-vanChuyen">
            <div class="card-body row">
              ...
              <div class="col-md-4">
                ...
                <p class="diaChi">Ấp 3B, Xã Đạo Thành, Đạo Thạnh, Thành phố Mỹ Tho, Tiền Giang, Việt Nam</p>
              </div>
              <div class="col-md-8" style="border-left: solid 1px rgb(171, 171, 171);">
                  ...
                  <thead>
                    <tr>
                      ...
                      <td scope="col">
                        ...
                        Người nhận hàng: Nguyễn Văn Tèo...
                      </td>
                    </tr>
                  </thead>
                  <tbody>
