...
<link rel="stylesheet" href="/views/css/BuyBookDetails.css">
</head>
<body>
    ...
    <main class="container shadow-sm p-3 mb-5 bg-body-tertiary rounded">
        <div class=" panel1 row">
            <article class="col-md-3">
                <div class="bigImg">
                    <img id="imgActive"
                        src="https://thuvienhoasen.org/images/file/SFO5nWNm2ggBAmBH/hat-giong-tam-hon.png" alt="">
                </div>
                <div class="smallImg">
                    <img class="imgItem"
                        src="https://thuvienhoasen.org/images/file/SFO5nWNm2ggBAmBH/hat-giong-tam-hon.png" alt="">
                    <img class="imgItem"
                        ...
                        alt="">
                    <img class="imgItem"
                        src="https://down-vn.img.susercontent.com/file/73f7a15b46f699b03d9fa3c8de733f1c" alt="">
                    <img class="imgItem"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body row">
                                <div id="carouselExampleControlsNoTouching" class="carousel slide  col-md-6"
                                    data-bs-touch="false">
            ...
            <aside class="col-md-9">
                <div class="panel-title row">
                    ...
                    <div class="col-md-2" style="margin-top: 20px;">
                        <span id="tym" style="font-size: 1.5rem; margin-right: 20px;"><i
                                class="bi bi-suit-heart-fill"></i></span>
                        <span id="share" style="font-size: 1.8rem; " data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5 text-center" id="staticBackdropLabel">SHARE
                                        </h1>
                                    ...
                                    <div class="modal-body" style="margin: 10px;">
                                        <div class="mb-3" style="margin-bottom: 10px;">
                                            <p>Hãy chia sẽ những quyển sách hay đến bạn bè.
                                            </p>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput1" class="form-label">Vui lòng nhập gmail</label>
                                            <input type="email"
                                                class="form-control border-primary" id="formGroupExampleInput1">
                                        </div>
                                        <div class="mb-3">
                                            <label for="formGroupExampleInput2" class="form-label">Vui lòng nhập nội dung gửi</label>
                                            <textarea name=""  class="form-control border-primary" id="formGroupExampleInput2"></textarea>
                                        </div>
                                    </div>
                ...
                <div class="body">
                    <div class="bodyPanle1 row">
                        <div class="col-md-2">
                            <p style="border-right: 1px solid gray;">4.2 <i class="bi bi-star-fill text-warning"></i>
                            </p>
                        </div>
                        <div class="col-md-3">
                            <p style="border-right: 1px solid gray; align-items: center; text-align: center;">120 lượt
                                đánh giá</p>
                        </div>
                        <div class="col-md-7">
                            <p>đã bán 1</p>
                    ...
                    <div class="bodyPanle3 row">
                        <p class="title col-md-1"><strong>Tình trạng: </strong></p>
                    ...
                    <div class="bodyPanle4">
                        ...
                        <div class="btn-group me-2" role="group" aria-label="First group">
                            ...
                            <input type="number" style="width: 60px;" class="btn-outline-secondary text-center"
                                name="btnradio" id="btnradio1" min="1" value="1">
                            <button type="button" class="btn btn-outline-secondary" onclick="increaseValue()">+</button>
                        </div>
                    </div>
                    <div class="footer">
                        <li class="d-inline-block bg-success border border-success px-5 py-2 rounded-5 mr-2 mb-2"
                            style="margin-right: 15px;">
                            <a href="#"
                                class="cursor-pointer text-light text-decoration-none font-weight-semibold d-flex justify-content-center">
                                <i class="bi bi-basket-fill"></i> &emsp14; Mua ngay</a>
                        </li>
                        <li class="d-inline-block bg-danger border border-danger px-5 py-2 rounded-5 mr-2 mb-2">
                            <a href="#"
                                class="cursor-pointer text-light text-decoration-none font-weight-semibold d-flex justify-content-center">
                                <i class="bi bi-cart4"></i>
                                &emsp14; Thêm vào giỏ hàng</a>
                        </li>
                    </div>
            </aside>
        </div>
        <div class="panel2 row">
            <div class="col-md-1">
                <img class="rounded-5" src="/views/img/account/anh1.jpg" alt="" width="80%">
            </div>
            <div class="col-md-11">
                <p>An an shop</p>
                       ...
                       <div class="card cardMoi SP">
                        ...
                        <div class="card-body">
                            ...
                            <div class="star">
                                ...
                                <span class="d-inline-block ml-2">Đã bán 120</span>
                            </div>
                            <div class="row">
                                <button class="col-md-6 btn btn-outline-danger">Mua Ngay</button>
                                <div class="col-md-6 "><i class="bi bi-heart-fill heard"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="panel5 ">
            ...
            <div class="header row">
                ...
                <aside class="col-md-10">
                    <a href="#1" class="DG-link" id="all">Tất cả</a>
                    <a href="#2" class="DG-link">5 sao</a>
                    <a href="#3" class="DG-link">4 sao</a>
                    <a href="#4" class="DG-link">3 sao</a>
                    <a href="#5" class="DG-link">2 sao</a>
                    <a href="#6" class="DG-link">1 sao</a>
                </aside>
            </div>
            <div class="danhgia">
                <!-- Cmt -->
                <div class="cmt row">
                    <div class="avatar col-md-1">
                        <img src="/views/img/account/anh1.jpg" alt="" class="rounded-5" width="45px" height="45px">
                    </div>
                    <div class="nd col-md-11">
                        ...
                        <p class="text-secondary fw-6"><i class="bi bi-clock"></i> 15-05-2024 &emsp13;| sản phẩm: sách
                            Hạt giống tâm hồn</p>
                        <p class="content"> <span class="text-secondary">chất lượng sản phẩm: </span><span>Tốt</span>
                        </p>
                        <p class="content"> <span class="text-secondary">Đúng với thông tin sản phẩm: </span><span>Đúng
                                ạ</span></p>

                        <p class="ndcmt">Đóng gói kỉ lưỡng.</p>
                        <div class="GDAnh">
                            <div class="GDAnhItems">
                                <img src="https://ghiensach.com/wp-content/uploads/2021/09/sach-ve-cuoc-song.jpg" alt=""
                                    height="100px">
                            </div>
                            <div class="GDAnhItems">
                                <img src="https://ghiensach.com/wp-content/uploads/2021/09/sach-ve-cuoc-song.jpg" alt=""
                        ...
                        <div class="phanhoi">
                            ...
                            <p class="text-secondary">Chúng tôi đã nhận được đánh giá tốt của bạn, chúng tôi rất vinh dự
                                khi nhận được sự khẳng định của bạn và rất mong được phục vụ bạn một lần nữa.
                            </p>
                        </div>
                    </div>
                </div>
