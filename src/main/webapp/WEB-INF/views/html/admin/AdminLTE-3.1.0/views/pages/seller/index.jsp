...
<!-- Theme style -->
<link rel="stylesheet" href="/views/html/admin/AdminLTE-3.1.0/dist/css/adminlte.min.css">
<!-- Link icon -->
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div
			...
			<img class="animation__wobble"
				src="/views/html/admin/AdminLTE-3.1.0/dist/img/AdminLTELogo.png" alt="AdminLTELogo"
				height="60" width="60">
		</div>
										...
										<div class="card-body">
											...
											<div class="direct-chat-messages">
												...
												<div class="direct-chat-msg">
													...
													<img class="direct-chat-img"
														src="/views/html/admin/AdminLTE-3.1.0/dist/img/user1-128x128.jpg"
												...
												<div class="direct-chat-msg right">
													...
													<!-- /.direct-chat-infos -->
													<img class="direct-chat-img"
														src="/views/html/admin/AdminLTE-3.1.0/dist/img/user3-128x128.jpg"
														alt="message user image">
													<!-- /.direct-chat-img -->
											...
											<div class="direct-chat-contacts">
												<ul class="contacts-list">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="/views/html/admin/AdminLTE-3.1.0/dist/img/user7-128x128.jpg"
															alt="User Avatar">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="/views/html/admin/AdminLTE-3.1.0/dist/img/user5-128x128.jpg"
															alt="User Avatar">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="/views/html/admin/AdminLTE-3.1.0/dist/img/user6-128x128.jpg"
															alt="User Avatar">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="/views/html/admin/AdminLTE-3.1.0/dist/img/user8-128x128.jpg"
															alt="User Avatar">
									...
									<ul class="products-list product-list-in-card pl-2 pr-2">
										<li class="item">
											<div class="product-img">
												<img src="/views/html/admin/AdminLTE-3.1.0/dist/img/default-150x150.png"
										...
										<li class="item">
											<div class="product-img">
												<img src="/views/html/admin/AdminLTE-3.1.0/dist/img/default-150x150.png"
													...
													src="/views/html/admin/AdminLTE-3.1.0/dist/img//default-150x150.png" alt="">
											</div>
											<div class="product-info">
...
<%@include file = "../views/footer.jsp" %>
	...
	<!-- REQUIRED SCRIPTS -->
	<!-- jQuery -->
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
	<!-- overlayScrollbars -->
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
	<!-- AdminLTE App -->
	<script src="/views/html/admin/AdminLTE-3.1.0/dist/js/adminlte.js"></script>

	<!-- PAGE PLUGINS -->
	<!-- jQuery Mapael -->
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/raphael/raphael.min.js"></script>
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mapael/jquery.mapael.min.js"></script>
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mapael/maps/usa_states.min.js"></script>
	<!-- ChartJS -->
	<script src="/views/html/admin/AdminLTE-3.1.0/plugins/chart.js/Chart.min.js"></script>

	<!-- AdminLTE for demo purposes -->
	<script src="/views/html/admin/AdminLTE-3.1.0/dist/js/demo.js"></script>
	<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
	<script src="/views/html/admin/AdminLTE-3.1.0/dist/js/pages/dashboard2.js"></script>
