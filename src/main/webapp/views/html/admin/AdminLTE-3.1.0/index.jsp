...
<body class="hold-transition sidebar-mini layout-fixed" ng-app="myApp">
	...
	<!-- jQuery Mapael -->
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/raphael/raphael.min.js"></script>
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mapael/jquery.mapael.min.js"></script>
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/jquery-mapael/maps/usa_states.min.js"></script>
	<!-- ChartJS -->
	<script
		src="/views/html/admin/AdminLTE-3.1.0/plugins/chart.js/Chart.min.js"></script>
