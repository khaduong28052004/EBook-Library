...
<title>Insert title here</title>
  <!-- Bootstrap CSS v5.2.1 -->
        ...
        <link rel="stylesheet" href="/views/css/evaluate.css">
        <script type="text/javascript" src="/views/js/evaluate.js"></script>
</head>
<body>
        ...
        <div class="col-9 menuNgangNe">
            <div class="nav navbar">
                    <div class="card-header headerTrangThai" style="background-color: white;">
                      <p class="tenNguoiBan"><img width="30" height="30" src="https://img.icons8.com/ios/50/back--v1.png" alt="back--v1" alt="left-squared"/> Đánh giá sản phẩm </p>
                      <p class="noiDungPhai" > <button type="submit" class=" btn btn-danger trangThai" data-bs-toggle="modal" data-bs-target="#successModal">
                        Gửi
                      </button></p>
                    </div>
            </div>
                      ...
                      <div class="info col-md-12">
                        <div class="card">
                          <div class="card-header">
                            <p>Đúng với thông tin sản phẩm: <span style="color:grey">để lại đánh giá</span></p>
                          </div>
                          <div class="card-body">
                        ...
                        <div class="info col-md-12">
                          <div class="card">
                            <div class="card-header">
                              <p>Chất lượng sản phẩm: <span style="color:grey">để lại đánh giá</span></p>
                            </div>
                            <div class="card-body">
                             <textarea name="" class="form-control" id="" required></textarea>
                            </div>
